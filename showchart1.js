...
//                       warningTime[i] = result[i].A;
//                       wareningRanking[i] = result[i].C;
//                     }
//                     // console.log(wareningRanking.length);

//                    var myChart_2 = echarts.init(document.querySelector('#flowPic'));
